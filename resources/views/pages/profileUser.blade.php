              ...
              <div class="form-row split">
                ...
                <div class="form-item">
                  ...
                  <div class="form-input small active">
                    ...
                    <input type="text" id="profile-name" name="profile_name" value="Galuh Gita">
                  </div>
                  <!-- /FORM INPUT -->
                </div>
                <!-- /FORM ITEM -->
                ...
                <div class="form-item">
                  ...
                  <div class="form-input small active">
                    ...
                    <input type="text" id="profile-public-email" name="profile_public_email" value="galuhgita@gmail.com">
                  </div>
                  <!-- /FORM INPUT -->
                </div>
                <!-- /FORM ITEM -->
